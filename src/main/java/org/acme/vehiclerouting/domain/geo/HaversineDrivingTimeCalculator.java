...
/**
 * Calculates the driving time (in seconds) between two locations by calculating
 * their Haversine distance in meters
 * assuming average speed {@link #AVERAGE_SPEED_KMPH}.
 */
@ApplicationScoped
public class HaversineDrivingTimeCalculator implements DrivingTimeCalculator {
